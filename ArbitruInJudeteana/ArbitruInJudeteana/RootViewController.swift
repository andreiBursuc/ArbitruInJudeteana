...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let startingViewController: BrigadeViewController = self.modelController.viewControllerAtIndex(0, storyboard: self.storyboard!)!
    ...
    func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewController.SpineLocation {
        ...
        let currentViewController = self.pageViewController!.viewControllers![0] as! BrigadeViewController
